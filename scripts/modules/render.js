import { getCurrentDateTime, calculsteDewPoint, convertPressure, getWeatherForecastData } from "./utils.js";
    ...
    widget.insertAdjacentHTML(
      ...
      <div class="widget__humidity">
        ...
        <p class="widget__humidity-text">Т.Р: ${
          calculsteDewPoint((data.main.temp - 273.15), data.main.humidity)}°C</p>
      </div>
